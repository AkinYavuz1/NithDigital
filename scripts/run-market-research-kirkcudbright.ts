...
const TARGET_LOCATION = "Kirkcudbright, DG6 (including nearby villages: Borgue, Gatehouse of Fleet, Twynholm, Ringford, Dundrennan, Auchencairn)"
const LOCATION_ILIKE = "%Kirkcudbright%"
const LOCATION_ILIKE_2 = "%DG6%"
...
Geographic rule: The business's primary trading address must be in Kirkcudbright town itself OR in one of these named villages within the DG6 postcode area: Borgue, Gatehouse of Fleet, Twynholm, Ringford, Dundrennan, Auchencairn. Do NOT include businesses based in Dumfries, Castle Douglas, or other towns that merely serve the area.

If the sector genuinely has fewer than 3 businesses not already in the list, document why in the notes field of each record (e.g. "Sector thin for Kirkcudbright — most operators based in Dumfries or Castle Douglas and travel in"). Still return what you find.
...
async function main() {
  console.log(`\n=== Nith Digital Phase 1 — Kirkcudbright/DG6 Market Research ===`)
