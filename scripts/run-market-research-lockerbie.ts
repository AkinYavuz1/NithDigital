...
const TARGET_LOCATION = "Lockerbie, DG11 (including nearby villages: Ecclefechan, Lochmaben, Hightae, Johnstonebridge, Beattock)"
const LOCATION_ILIKE = "%Lockerbie%"
const LOCATION_ILIKE_2 = "%DG11%"
...
Geographic rule: The business's primary trading address must be in Lockerbie town itself OR in one of these named villages within the DG11 postcode area: Ecclefechan, Lochmaben, Hightae, Johnstonebridge, Beattock. Do NOT include businesses based in Dumfries, Annan, or other towns that merely serve the area.

If the sector genuinely has fewer than 3 businesses not already in the list, document why in the notes field of each record (e.g. "Sector thin for Lockerbie — most operators based in Dumfries and travel in"). Still return what you find.
...
async function main() {
  console.log(`\n=== Nith Digital Phase 1 — Lockerbie/DG11 Market Research ===`)
