...
const TARGET_LOCATION = "Annan, DG12 (including nearby villages: Brydekirk, Dornock, Eastriggs, Gretna, Kirtlebridge, Powfoot)"
const LOCATION_ILIKE = "%Annan%"
const LOCATION_ILIKE_2 = "%DG12%"
...
Geographic rule: The business's primary trading address must be in Annan town itself OR in one of these named villages within the DG12 postcode area: Brydekirk, Dornock, Eastriggs, Gretna, Kirtlebridge, Powfoot. Do NOT include businesses based in Dumfries, Lockerbie, or other towns that merely serve the area.

If the sector genuinely has fewer than 3 businesses not already in the list, document why in the notes field of each record (e.g. "Sector thin for Annan — most operators based in Dumfries and travel in"). Still return what you find.
...
async function main() {
  console.log(`\n=== Nith Digital Phase 1 — Annan/DG12 Market Research ===`)
