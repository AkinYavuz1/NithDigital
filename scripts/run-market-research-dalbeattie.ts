...
const TARGET_LOCATION = "Dalbeattie, DG5 (including nearby villages: Palnackie, Haugh of Urr, Kirkgunzeon, Sandyhills, Kippford)"
const LOCATION_ILIKE = "%Dalbeattie%"
const LOCATION_ILIKE_2 = "%DG5%"
...
Geographic rule: The business's primary trading address must be in Dalbeattie town itself OR in one of these named villages within the DG5 postcode area: Palnackie, Haugh of Urr, Kirkgunzeon, Sandyhills, Kippford. Do NOT include businesses based in Dumfries, Castle Douglas, or other towns that merely serve the area.

If the sector genuinely has fewer than 3 businesses not already in the list, document why in the notes field of each record (e.g. "Sector thin for Dalbeattie — most operators based in Dumfries or Castle Douglas and travel in"). Still return what you find.
...
async function main() {
  console.log(`\n=== Nith Digital Phase 1 — Dalbeattie/DG5 Market Research ===`)
