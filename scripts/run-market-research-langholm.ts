...
const TARGET_LOCATION = "Langholm, DG13 (including nearby villages: Canonbie, Ewes, Bentpath, Westerkirk, Tarras)"
const LOCATION_ILIKE = "%Langholm%"
const LOCATION_ILIKE_2 = "%DG13%"
...
Geographic rule: The business's primary trading address must be in Langholm town itself OR in one of these named villages within the DG13 postcode area: Canonbie, Ewes, Bentpath, Westerkirk, Tarras. Do NOT include businesses based in Carlisle, Dumfries, or other towns that merely serve the area.

If the sector genuinely has fewer than 3 businesses not already in the list, document why in the notes field of each record (e.g. "Sector thin for Langholm — small town of ~2,200, most operators travel in from Carlisle or Dumfries"). Still return what you find.
...
async function main() {
  console.log(`\n=== Nith Digital Phase 1 — Langholm/DG13 Market Research ===`)
