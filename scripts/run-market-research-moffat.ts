...
const TARGET_LOCATION = "Moffat, DG10 (including nearby villages: Beattock, Capplegill, Greystone, Wamphray)"
const LOCATION_ILIKE = "%Moffat%"
const LOCATION_ILIKE_2 = "%DG10%"
...
Geographic rule: The business's primary trading address must be in Moffat town itself OR in one of these named villages within the DG10 postcode area: Beattock, Capplegill, Greystone, Wamphray. Do NOT include businesses based in Dumfries, Lockerbie, or other towns that merely serve the area.

If the sector genuinely has fewer than 3 businesses not already in the list, document why in the notes field of each record (e.g. "Sector thin for Moffat — most operators based in Dumfries and travel in"). Still return what you find.
...
async function main() {
  console.log(`\n=== Nith Digital Phase 1 — Moffat/DG10 Market Research ===`)
