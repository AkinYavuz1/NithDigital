...
const TARGET_LOCATION = "Stranraer, DG9 (including nearby villages: Leswalt, Portpatrick, Lochans, Cairnryan, Dunragit, Glenluce)"
const LOCATION_ILIKE = "%Stranraer%"
const LOCATION_ILIKE_2 = "%DG9%"
...
Geographic rule: The business's primary trading address must be in Stranraer town itself OR in one of these named villages within the DG9 postcode area: Leswalt, Portpatrick, Lochans, Cairnryan, Dunragit, Glenluce. Do NOT include businesses based in Newton Stewart, Dumfries, or other towns that merely serve the area.

If the sector genuinely has fewer than 3 businesses not already in the list, document why in the notes field of each record (e.g. "Sector thin for Stranraer — most operators based in Newton Stewart and travel in"). Still return what you find.
...
async function main() {
  console.log(`\n=== Nith Digital Phase 1 — Stranraer/DG9 Market Research ===`)
