...
const TARGET_LOCATION = "Castle Douglas, DG7 (including nearby villages: Crossmichael, Gelston, Rhonehouse, Kelton, Crocketford, Balmaclellan, Corsock)"
const LOCATION_ILIKE = "%Castle Douglas%"
const LOCATION_ILIKE_2 = "%DG7%"
...
Geographic rule: The business's primary trading address must be in Castle Douglas town itself OR in one of these named villages within the DG7 postcode area: Crossmichael, Gelston, Rhonehouse, Kelton, Crocketford, Balmaclellan, Corsock. Do NOT include businesses based in Dumfries, Kirkcudbright, or other towns that merely serve the area.

If the sector genuinely has fewer than 3 businesses not already in the list, document why in the notes field of each record (e.g. "Sector thin for Castle Douglas — most operators based in Dumfries and travel in"). Still return what you find.
...
async function main() {
  console.log(`\n=== Nith Digital Phase 1 — Castle Douglas/DG7 Market Research ===`)
