...
const TARGET_LOCATION = "Newton Stewart, DG8 (including nearby villages: Minnigaff, Creetown, Kirkcowan, Wigtown, Bladnoch, Garlieston)"
const LOCATION_ILIKE = "%Newton Stewart%"
const LOCATION_ILIKE_2 = "%DG8%"
...
Geographic rule: The business's primary trading address must be in Newton Stewart or Minnigaff town itself OR in one of these named villages within the DG8 postcode area: Creetown, Kirkcowan, Wigtown, Bladnoch, Garlieston. Do NOT include businesses based in Dumfries, Stranraer, or other towns that merely serve the area.

If the sector genuinely has fewer than 3 businesses not already in the list, document why in the notes field of each record (e.g. "Sector thin for Newton Stewart — most operators based in Dumfries or Stranraer and travel in"). Still return what you find.
...
async function main() {
  console.log(`\n=== Nith Digital Phase 1 — Newton Stewart/DG8 Market Research ===`)
