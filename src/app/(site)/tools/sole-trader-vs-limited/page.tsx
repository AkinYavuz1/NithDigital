    ...
    <>
      ...
      <section style={{ background: '#1A1A1A', padding: '64px 0 48px' }}>
        <div style={{ maxWidth: 1080, margin: '0 auto', padding: '0 24px' }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 36, color: '#FAF8F5', fontWeight: 400, marginBottom: 12 }}>Sole Trader vs Limited Company</h1>
          <p style={{ fontSize: 16, color: 'rgba(250,248,245,0.7)' }}>Find out which business structure suits you best — and how much it matters for your tax bill.</p>
        </div>
      </section>
