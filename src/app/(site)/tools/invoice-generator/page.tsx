    ...
    <>
      ...
      <section style={{ background: '#1A1A1A', padding: '64px 0 48px' }}>
        <div style={{ maxWidth: 1080, margin: '0 auto', padding: '0 24px' }}>
          <p style={{ fontSize: 11, letterSpacing: '1.5px', textTransform: 'uppercase', color: '#E85D3A', marginBottom: 12, fontWeight: 600 }}>Free tool · No signup · Nothing saved</p>
          <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 36, color: '#FAF8F5', fontWeight: 400, marginBottom: 12 }}>Free Invoice Generator</h1>
          <p style={{ fontSize: 16, color: 'rgba(250,248,245,0.7)' }}>Create a professional invoice and download as PDF in seconds.</p>
        </div>
      </section>
