...
export default function BlogPostContent({ slug }: { slug: string }) {
  ...
  if (loading) return (
    <div style={{ maxWidth: 720, margin: '80px auto', padding: '0 24px', textAlign: 'center', color: '#5A6A7A', fontSize: 14 }}>
      Loading...
    </div>
  )
      ...
      <section style={{ background: '#1B2A4A', padding: '64px 0 48px' }}>
        <div style={{ maxWidth: 1080, margin: '0 auto', padding: '0 24px' }}>
          ...
          <div style={{ marginBottom: 16 }}>
            <span style={{ display: 'inline-block', fontSize: 10, padding: '3px 10px', borderRadius: 100, background: '#D4A84B', color: '#1B2A4A', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.5px' }}>
