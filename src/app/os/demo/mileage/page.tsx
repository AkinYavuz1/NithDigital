              ...
              {logs.map(log => (
                <tr key={log.id} style={{ borderBottom: '1px solid rgba(27,42,74,0.06)' }}>
                  <td className="td-primary" data-label="" style={{ padding: '12px 16px', fontWeight: 600 }}>
                    ...
                    <span style={{ marginLeft: 8, fontSize: 12, color: '#5A6A7A', fontWeight: 400 }}>{log.miles.toFixed(1)} mi</span>
                  </td>
                  ...
                  <td className="td-hide" data-label="Miles" style={{ padding: '12px 16px', fontWeight: 600 }}>{log.miles.toFixed(1)}</td>
                  <td data-label="Purpose" style={{ padding: '12px 16px', color: '#5A6A7A' }}>{log.purpose}</td>
                  <td className="td-hide" data-label="Rate" style={{ padding: '12px 16px' }}>{(log.rate_per_mile * 100).toFixed(0)}p</td>
                  <td data-label="Claim" style={{ padding: '12px 16px', fontWeight: 600, color: '#D4A84B' }}>{formatCurrency(log.total_claim)}</td>
                </tr>
              ))}
