      ...
      <section style={{ maxWidth: 1080, margin: '0 auto', padding: '56px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 20, marginBottom: 48 }} className="bi-grid">
          {[
            ...
            >
              <h4 style={{ fontSize: 14, fontWeight: 600, marginBottom: 6, color: '#1B2A4A' }}>{item.title}</h4>
              <p style={{ fontSize: 13, lineHeight: 1.6, color: '#5A6A7A', margin: 0 }}>{item.desc}</p>
            </div>
          ))}
        </div>
        ...
        <div style={{ background: '#1B2A4A', borderRadius: 12, padding: '40px 48px', textAlign: 'center', color: '#F5F0E6' }}>
          ...
          <p style={{ fontSize: 14, color: 'rgba(245,240,230,0.6)', marginBottom: 20, maxWidth: 440, margin: '0 auto 20px' }}>
