...
export const metadata: Metadata = {
  title: 'Free Invoice Generator — Create & Download PDF Invoices | Nith Digital',
  description: 'Generate professional invoices and download as PDF for free. No signup required. Supports VAT, multiple line items, and custom payment terms.',
}
